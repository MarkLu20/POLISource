 ...
 */
class PLUGINTREEVIEW_API SMkExpanderArrow : public SCompoundWidget
{
public:

	SLATE_BEGIN_ARGS( SMkExpanderArrow )
	...
	void Construct( const FArguments& InArgs, const TSharedPtr<class ITableRow>& TableRow, FSlateBrush& expander, FSlateBrush& expanderHover, FSlateBrush& collapsed, FSlateBrush& collapsedHover );
